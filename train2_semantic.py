...
def train_network(net, device, trainloader, val_generator, nr_epochs, SAVE_PATH, optimizer, scheduler, current_best_acc, start_epoch, mod, view_outputs=False):
    ...
    File_object = open(r"E:\an_4_LICENTA\Workspace\Scripturi\core_semantic\results_semantic\ABSOLUTE_FULL_DTS__unet_semantic_brats_2D_v3_COPIE_sigmaoida_fcost_dice_Vlad_weights_batch_gibbsremove_eph61.txt", "a")
    #File_object = open(r"E:\an_4_LICENTA\Workspace\Scripturi\core_semantic\results_semantic\transferLR_1_test.txt", "a")
