...
def inference_on_dataset_1doutout_semantic(net, inference_generator, SAVE_PATH, saveaspng):
    net.eval()
    for i, data in enumerate(inference_generator):
        ...
        if saveaspng:
            ...
            cv2.imwrite(SAVE_PATH + '\\' + 'seg_' + filepath[0].split('\\')[-1] + '.png', output)
...
def main():
    ...
    SAVE_PATH = r'E:\an_4_LICENTA\Workspace\Dataset\Val_Official_Dataset\zOUTPUT_for_suibmission\output_ABSOLUTE_FULL_DTS__unet_semantic_brats_2D_v3_COPIE_sigmaoida_fcost_dice_Vlad_weights_batch_gibbsremove_eph68' 
    ...
    inference_on_dataset_1doutout_semantic(net, inference_generator, SAVE_PATH, saveaspng=True)
    ...
    '''
    INPUT_PNG_PRED_DIR = r"E:\an_4_LICENTA\Workspace\Dataset\Val_Official_Dataset\zOUTPUT_for_suibmission\output_ABSOLUTE_FULL_DTS__unet_semantic_brats_2D_v3_COPIE_sigmaoida_fcost_dice_Vlad_weights_batch_gibbsremove_eph68"
    OUTPUT_NII_PRED_DIR = r"E:\an_4_LICENTA\Workspace\Dataset\Val_Official_Dataset\zOUTPUT_for_submission_NII\output_ABSOLUTE_FULL_DTS__unet_semantic_brats_2D_v3_COPIE_sigmaoida_fcost_dice_Vlad_weights_batch_gibbsremove_eph68"
